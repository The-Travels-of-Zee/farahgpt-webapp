...
import { signInWithGoogle, signUpInstructorWithEmail } from "@/lib/actions/authActions";
    ...
    <div className="min-h-screen  bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-primary to-(--primary-light) p-8 lg:p-12 flex flex-col justify-center text-white relative overflow-hidden"
        >
          {/* Back Button */}
          <Link
            href="/signup-user"
            className="absolute flex gap-1 top-8 left-8 p-2 hover:bg-white/20 rounded-full transition-colors"
          >
            ...
            <motion.form variants={itemVariants} onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <div className="relative">
                  <User className="absolute left-4 top-1/2 transform -translate-y-1/2 text-(--primary-light) w-5 h-5" />
                  <input
                    type="text"
                    ...
                    className={`w-full pl-12 pr-4 py-4 border-2 rounded-xl focus:outline-none transition-colors ${
                      errors.fullName
                        ...
                        : "border-gray-200 focus:border-(--primary-light)"
                    }`}
                  />
                </div>
                {errors.fullName && (
              ...
              <div>
                <div className="relative">
                  <Mail className="absolute left-4 top-1/2 transform -translate-y-1/2 text-(--primary-light) w-5 h-5" />
                  <input
                    type="email"
                    placeholder="Email"
              ...
              <div>
                <div className="relative">
                  <Lock className="absolute left-4 top-1/2 transform -translate-y-1/2 text-(--primary-light) w-5 h-5" />
                  <input
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-(--primary-light) transition-colors"
                  >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-gradient-to-r from-primary to-(--primary-light) text-white py-4 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? (
              ...
              <motion.button
                ...
                className="w-full border-2 border-gray-200 text-gray-700 py-4 rounded-xl font-semibold text-lg hover:border-gray-300 transition-colors flex items-center justify-center space-x-3 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isGoogleLoading ? (
                  <div className="flex items-center justify-center space-x-2">
