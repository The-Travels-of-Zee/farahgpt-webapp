    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center space-y-2">
          <h2 className="text-3xl font-bold text-teal-700">Choose Your Plan</h2>
        ...
        >
          <div className="flex justify-between items-start mb-4">
            <div>
              <h3 className="text-2xl font-bold text-slate-800">Free Tier</h3>
        ...
        <motion.div
          variants={itemVariants}
          className="relative bg-gradient-to-br from-white to-teal-50 rounded-2xl p-6 shadow-xl border-2 border-teal-200 hover:shadow-2xl transition-shadow duration-300"
        >
          <motion.div
          ...
          <div className="flex justify-between items-start mb-4">
            <div>
              <h3 className="text-2xl font-bold text-slate-800">Premium Tier</h3>
        ...
        <motion.div variants={itemVariants} className="space-y-3">
          <motion.button
            ...
            className="w-full bg-gradient-to-r from-teal-600 to-teal-700 text-white py-4 rounded-2xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300"
          ...
          <motion.button
            className="w-full bg-slate-100 text-slate-700 py-4 rounded-2xl font-semibold hover:bg-slate-200 transition-colors duration-300"
              ...
              <div className="bg-white rounded-3xl p-8 max-w-sm w-full shadow-2xl">
                <div className="text-center space-y-6">
                  ...
                  <div className="flex space-x-3">
                    <motion.button
                      onClick={() => setShowUpgradeModal(false)}
                      className="flex-1 py-3 text-slate-600 font-semibold hover:text-slate-800 transition-colors"
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                    >
                      Cancel
                    ...
                    <motion.button
                      className="flex-1 bg-gradient-to-r from-teal-600 to-teal-700 text-white py-3 rounded-xl font-bold shadow-lg hover:shadow-xl transition-all duration-300"
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                    >
                      Confirm
